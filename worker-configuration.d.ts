/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 01e1735178958729787cb858e4ddf077)
// Runtime types generated with workerd@1.20251213.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "AppContainer" | "S3" | "Computers" | "Logs";
	}
	interface Env {
		APP_CONTAINER: DurableObjectNamespace<import("./worker/index").AppContainer>;
		S3: DurableObjectNamespace<import("./worker/index").S3>;
		COMPUTERS: DurableObjectNamespace<import("./worker/index").Computers>;
		LOGS: DurableObjectNamespace<import("./worker/index").Logs>;
	}
}
